...
export function installGLiveView(network: string): Array<string> {
    return [
        ...
        'curl -s -o /cardano/glive-view/gLiveView.sh https://raw.githubusercontent.com/cardano-community/guild-operators/master/scripts/cnode-helper-scripts/gLiveView.sh',
